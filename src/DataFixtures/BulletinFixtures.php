...
class BulletinFixtures extends Fixture
{
    ...
    public function makeContent()
    {
        ...
        $contents = [
            ...
            ("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse consectetur viverra metus, id lobortis elit fermentum non."),
        ...
        return "Lorem Ipsum " . $contents[rand(0, count($contents) - 1)];
    }
}
